  ...
  return (
    <div className="bg-[#131313] text-[#e5e2e1] font-sans h-screen w-full overflow-hidden flex flex-col relative">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-sm">
        <nav className="flex justify-between items-center w-full px-6 md:px-10 h-16 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button className="text-[14px] font-medium text-[#d0c6ab] hover:text-[#e5e2e1] transition-all active:scale-95" onClick={() => navigate('/login')}>Login</button>
            <button className="bg-[#FFD700] text-[#705e00] px-5 py-1.5 rounded-full text-[14px] font-semibold active:scale-95 transition-transform" onClick={() => navigate('/register')}>Sign Up</button>
          </div>
        </nav>
      </header>
      ...
      <main className="relative h-full w-full flex items-center justify-center pt-8 pb-12">
        ...
        {/* Login Card with Internal Scroll */}
        <div 
        ...
        >
          <div className="text-center mb-6">
            <h1 className="text-[28px] font-semibold text-[#e5e2e1] mb-1">Welcome Back</h1>
            <p className="text-[14px] text-[#d0c6ab]">Access your Studio account.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5 relative">
              <label className="text-[13px] font-medium text-[#d0c6ab] ml-1 flex justify-between">
                <span>Password</span>
                <a href="#" className="hover:text-[#FFD700] transition-colors">Forgot?</a>
              </label>
            ...
            <button 
              type="submit"
              className="w-full bg-[#FFD700] text-[#705e00] font-semibold text-[15px] py-3 rounded-lg shadow-lg active:scale-[0.98] transition-all hover:opacity-90 duration-300 mt-2"
            >
              Login
            </button>
          ...
          <div className="mt-6 text-center">
            <Link to="/register" className="text-[13px] font-medium text-[#d0c6ab] hover:text-[#FFD700] transition-colors">
              Don't have an account? <span className="text-[#FFD700] font-semibold">Sign Up</span>
            </Link>
          </div>
        </div>
      </main>
